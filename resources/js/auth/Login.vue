...
<div class="w-full bg-white rounded-xl p-2.5">
    <div class="border-2 border-gray-300 p-4 rounded-xl">
        <form @submit.prevent="login()">
            ...
            <input v-model="user.password" type="text" class="w-full p-1.5 bg-white border-2 border-birumateri rounded-md focus:outline-none focus:ring focus:ring-indigo-200 focus:ring-opacity-50">

            <div class="flex justify-center items-end m-3">
                <button class="bg-birumateri py-1.5 px-3 rounded-md text-white font-semibold text-base">Log in</button>
            </div>
        </form>
