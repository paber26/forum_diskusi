    ...
    <div class="flex w-full justify-center">
        <div class="bg-gray-200 w-11/12 mt-4 p-2 rounded-2xl">
            ...
            <div class="grid grid-cols-12 gap-2 mt-2 font-semibold text-white py-2">
                <a href="/modul/aljabar-linear" class="p-5 bg-birumateri hover:bg-yellow-300 rounded-xl col-span-12 sm:col-span-6 lg:col-span-4 text-center">Aljabar Linear</a>
...
export default {
    data() {
        return {
            showisikategori: false,
        }
    },
    methods: {
        klikisikategori: function () {
            this.showisikategori = !this.showisikategori
            console.log(this.showisikategori)
        }
    }
}
</script>
